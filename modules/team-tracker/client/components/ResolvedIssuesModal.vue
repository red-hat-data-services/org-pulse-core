        ...
        <table class="w-full text-sm">
          <thead class="sticky top-0 bg-white dark:bg-gray-800">
            <tr class="border-b border-gray-200 dark:border-gray-700">
              ...
              <th class="text-left py-2 px-2 text-gray-500 dark:text-gray-400 font-medium cursor-pointer hover:text-gray-700 dark:hover:text-gray-300" @click="toggleSort('issueType')">
              ...
              <th class="text-right py-2 px-2 text-gray-500 dark:text-gray-400 font-medium cursor-pointer hover:text-gray-700 dark:hover:text-gray-300" @click="toggleSort('storyPoints')">
                Points {{ sortIcon('storyPoints') }}
              </th>
              <th class="text-left py-2 px-2 text-gray-500 dark:text-gray-400 font-medium cursor-pointer hover:text-gray-700 dark:hover:text-gray-300" @click="toggleSort('resolutionDate')">
          ...
          <tbody>
            ...
            >
              ...
              <td class="py-2 px-2 text-gray-700 dark:text-gray-300">{{ issue.assignee || 'Unassigned' }}</td>
              <td class="py-2 px-2 text-right text-gray-700 dark:text-gray-300">{{ issue.storyPoints || 0 }}</td>
              <td class="py-2 px-2 text-gray-500 dark:text-gray-400 text-xs">{{ formatDate(issue.resolutionDate) }}</td>
            </tr>
          </tbody>
        </table>
      </div>

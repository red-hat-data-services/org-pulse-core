...
**Org Pulse Core** — the reusable core platform for Org Pulse, a modular
engineering dashboard connecting Jira, GitHub, and GitLab data with a team
roster to surface delivery insights. Vue 3 + Express, deployed on OpenShift
via ArgoCD. Organizations extend this core by adding custom modules.
...
lightweight fetching, caching, and serving.
...
Current core modules: team-tracker.
